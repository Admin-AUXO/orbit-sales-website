  ...
  return (
    <PageShell>
      ...
      <PageHeader
        ...
        title="Decades of brain science. Distilled for daily performance."
      ...
      <section className="py-16 md:py-24">
        <div className="mx-auto max-w-[var(--ns-max-width)] px-6 lg:px-8">
          <FadeIn>
            <h2 className="font-display text-3xl text-ns-text">Scientific foundation</h2>
            <p className="mt-4 max-w-3xl leading-relaxed text-ns-text-muted">
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-3">
            {specs.map((spec, i) => (
              <FadeIn key={spec.category} delay={i * 0.1}>
